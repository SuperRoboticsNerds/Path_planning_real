...
{
    int i;
    std::string probSpecFile;
    bool flag = false;
    while(!flag)
    {
        cout << "Please enter the map's (problem) number (1, 2 or 3):  \n";
        cin >> i;
        //cout << "The value you entered is " << i;

        if(i==1)
        {probSpecFile = "problem1.txt";flag = true;}
        else if (i==2)
        {probSpecFile = "problem2.txt";flag = true;}
        else if (i==3)
        {probSpecFile = "problem3.txt";flag = true;}
        else cout << "Please enter a valid number  \n";
        //std::string probSpecFile = "problem2.txt";
    }
